function updateClock() {
    ...
    // Update elements
    document.getElementById('nav-time').textContent = timeShort;
    document.getElementById('nav-day').textContent = dayName;
    document.getElementById('nav-date').textContent = dateShort;
